...
exports.OrdenVentaModel = void 0;
...
const ordenVentaSchema = new mongoose_1.default.Schema({
    folio: {
        type: Number,
        default: 0,
    },
    ...
    virtuals: {
        ...
        fechaPago: {
            get() {
                const f = new Date(this.fecha.setMonth(this.fecha.getMonth() + 2));
                const months = ['enero', 'febrero', 'marzo', 'abril', 'mayo', 'junio', 'julio', 'agosto', 'septiembre', 'octubre', 'noviembre', 'diciembre'];
                return this.fecha.getDate() + ' de ' + months[this.fecha.getMonth()] + ' de ' + this.fecha.getFullYear();
            }
        },
...
exports.OrdenVentaModel = mongoose_1.default.model('OrdenVenta', ordenVentaSchema);
